...
- [ ] M0-01 — Décider mono-repo vs multi-repos (mobile/backend) + conventions (naming, env, versions). Réf: [ARCHITECTURE.md](../ARCHITECTURE.md#arch-deploiement), [TODO_PLATFORM_DEVOPS.md](./TODO_PLATFORM_DEVOPS.md#pl-top).
