...
- [ ] FE-001 — Bootstrap app Expo + TS + React Navigation (tabs + stacks) + structure feature-first. Réf: [ARCHITECTURE.md](../ARCHITECTURE.md#arch-stack-mobile).
- [ ] FE-002 — Data fetching/cache: TanStack Query + client OpenAPI typé + retry/backoff. Réf: [ARCHITECTURE.md](../ARCHITECTURE.md#arch-stack-mobile), [ARCHITECTURE.md](../ARCHITECTURE.md#arch-api-backend).
